...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Chess puzzles (Bootstrapping)}: a sequence of intermediate-sized students $M_1 \to M_2 \to \dots \to M_n$ where each $M_{i+1}$ is supervised by $M_i$,  aligning with the ``align-slightly-superhuman-first'' alignment plan \cite{leike2018scalable}.
